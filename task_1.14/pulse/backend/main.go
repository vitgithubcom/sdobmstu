...
var mockKPI = []KPI{
    ...
    {ID: 3, Title: "Простои", Value: "124", Unit: "часов", Plan: 80.0, Delta: 55, Trend: "down", Status: "critical"},
    {ID: 4, Title: "Заказы в срок", Value: "87.2", Unit: "%", Plan: 92.0, Delta: -4.8, Trend: "down", Status: "warning"},
